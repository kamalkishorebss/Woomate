...
class ShippingDetailForm extends StatefulWidget {
  @override
  _ShippingDetailFormState createState() => _ShippingDetailFormState();
}

class _ShippingDetailFormState extends State<ShippingDetailForm> {
